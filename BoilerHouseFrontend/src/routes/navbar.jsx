    ...
    <nav className="bg-gray-200 p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex space-x-8 text-lg">
          ...
          <li><NavLink to={`/profile/${localStorage.getItem('username')}`} className="text-black  hover:text-yellow-500 px-3 py-2 rounded-md transition duration-300 font-bold">Profile</NavLink></li>
        </ul>
      </div>
    </nav>
    <Outlet />
