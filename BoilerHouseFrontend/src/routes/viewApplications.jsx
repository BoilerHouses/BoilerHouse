      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex justify-center h-screen">
          <p className="text-black text-center font-bold rounded-md">
            No clubs that match search criteria are pending approval
          </p>
        </div>
      </div>
    );
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      {filteredClubs.map((club) => (
        ...
        >
          ...
          />
          <span className="ml-4 text-black font-semibold" index={club.k}>
            Club:
          </span>
          <span className="ml-4 text-black" index={club.k}>
            {club.name}
          </span>
          <span className="ml-4 text-black font-semibold" index={club.k}>
            Owner:
